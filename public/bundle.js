	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement('input', { type: 'text', placeholder: 'City Name', ref: 'location' }),
	        React.createElement(
	          'button',
	          null,
	          'Get Weather'
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var appId = '75bdde3be636ef2d2c94c5dbfb09f55d';
	var units = 'imperial';
	...
	module.exports = {
	  getTemp: function getTemp(location) {
	    ...
	    var requestUrl = '' + OPEN_WEATHER_MAP_URL + encodedLocation + '&units=' + units + '&appid=' + appId;
